    ...
    with con:
        if(User.First_Name):
            cur.execute('''INSERT INTO Users (First_Name, Last_Name, link_userid, Face_userid, Insta_userid, Git_userid, Hack_userid, Twit_userid, Chef_userid)
                        VALUES (:First_Name, :Last_Name, :link_userid, :Face_userid, :Insta_userid, :Git_userid, :Hack_userid, :Twit_userid, :Chef_userid)''', {'First_Name': User.First_Name, 'Last_Name': User.Last_Name, 'link_userid': User.Link_userid, 'Face_userid': User.Face_userid, 'Insta_userid': User.Insta_userid, 'Git_userid': User.Git_userid, 'Hack_userid': User.Hack_userid, 'Twit_userid': User.Twit_userid, 'Chef_userid': User.Chef_userid})
